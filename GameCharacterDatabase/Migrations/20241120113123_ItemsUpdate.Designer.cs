...
namespace GameCharacterDatabase.Migrations
{
    ...
    [Migration("20241120113123_ItemsUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameCharacterDatabase.Models.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameCharacterDatabase.Models.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameCharacterDatabase.Models.Inventory", b =>
                {
                    b.HasOne("GameCharacterDatabase.Models.Character", "Character")
                        .WithOne("Inventory")
                        .HasForeignKey("GameCharacterDatabase.Models.Inventory", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameCharacterDatabase.Models.Item", b =>
                {
                    b.HasOne("GameCharacterDatabase.Models.Inventory", "Inventory")
                        .WithMany("Items")
